---
title: "Run agents in sandboxes."
description: "Without giving them your keys."
---

Self-hosted Kubernetes infrastructure for Claude Code, Codex, and any coding agent. A vault proxy swaps stub credentials for real keys at the wire level — agents never hold the real values.
